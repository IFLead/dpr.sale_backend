...
class Post(models.Model):
    ...
    # currency = models.ForeignKey(Currency, verbose_name='Валюта', default=1)
    ...
    corner = models.NullBooleanField('Угловая', null=True,)
    material = models.ForeignKey(Material, verbose_name='Материал', null=True,)
    balcony = models.NullBooleanField('Балкон застеклён', null=True,)
    window = models.ForeignKey(Window, verbose_name='Окно', null=True,)
    state = models.ForeignKey(State, verbose_name='Состояние', null=True,)
    living_space = models.ForeignKey(Living_space, verbose_name='Жилая площадь', null=True,)
